...
namespace HotelProject.WebUI.ValidationRules.GuestValidationRules
{
    public class GuestCreateValidator:AbstractValidator<CreateGuestDto>
    {
        public GuestCreateValidator()
        {
            ...
            RuleFor(x => x.Surname).MinimumLength(2).WithMessage("Lütfen en az  karakter veri girişi yapınız");
            ...
            RuleFor(x => x.Surname).MaximumLength(25).WithMessage("Lütfen fazla  25 karakter veri girişi yapınız");
